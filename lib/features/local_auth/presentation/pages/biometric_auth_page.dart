...
import 'package:rojnivis/features/local_auth/presentation/bloc/login/local_auth_login_bloc.dart';
import 'package:rojnivis/features/local_auth/presentation/bloc/login/local_auth_login_event.dart';
import 'package:rojnivis/features/local_auth/presentation/bloc/login/local_auth_login_state.dart';
import 'package:rojnivis/features/local_auth/presentation/widgets/local_auth_numpad.dart';
import 'package:rojnivis/features/local_auth/presentation/widgets/local_auth_pin_dots.dart';
import 'dart:async';
...
class _BiometricAuthPageState extends State<BiometricAuthPage>
  ...
  void _handleKeyPress(String value, bool isLockedOut) {
    ...
    if (_enteredPin.length == LocalAuthConstants.pinLength) {
      context.read<LocalAuthLoginBloc>().add(
        VerifyPinLoginEvent(pin: _enteredPin),
      );
    }
  }
